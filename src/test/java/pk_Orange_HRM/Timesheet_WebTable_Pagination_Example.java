...
public class Timesheet_WebTable_Pagination_Example {
  @Test
  public void Pagination_Example() throws InterruptedException {
	    WebDriverManager.chromedriver().setup();
	    WebDriver driver = new ChromeDriver();
	    driver.manage().window().maximize();
	    driver.get("https://hcsproject.harman.com/Time/Timesheets/myapproval");
	    Thread.sleep(5000);
        Select SelectPass = new Select(driver.findElement(By.id("ddlWeekSelection")));
		SelectPass.selectByVisibleText("Prev 6 Month");
		Thread.sleep(5000);
	    //Get all Name from Table
	    List<WebElement> FnameElements=driver.findElements(By.xpath("//table[@id='tblDetailView']/tbody/tr/td[1]"));
	    ...
	    String nextButton = driver.findElement(By.xpath("//a[@title='Next']")).getAttribute("class");
	    while(!nextButton.contains("disabled"))
	    {
	    	...
	    	FnameElements=driver.findElements(By.xpath("//table[@id='tblDetailView']/tbody/tr/td[1]"));
	    	...
	    	nextButton = driver.findElement(By.xpath("//a[@title='Next']")).getAttribute("class");
	    	Thread.sleep(3000);
	    }
	    ...
	    String totalcount = driver.findElement(By.id("tblDetailView_info")).getText().split(" ")[5];
